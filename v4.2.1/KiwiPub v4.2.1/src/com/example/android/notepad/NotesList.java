...
public class NotesList extends ListActivity {
	...
	protected final void openFile(){
		...
		alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int whichButton) {
				...
				allText = UnZip.allText;
				allImagePaths = UnZip.allImagePaths;	
				
				*/
				Intent i = new Intent(NotesList.this, Reader.class);
				Bundle b = new Bundle();
				b.putString("path", path);
				i.putExtra("bundle", b);
				Log.d("AAAA", "DEBUGGING ");
	...
	public void openHelp() {
		...
		Intent myIntent = new Intent(NotesList.this, Help.class);
