	...
	protected final void openFile(){
		...
		alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int whichButton) {
				 ...
				 * SHUANG,
				 * 
				 * get string lists from unzip
				 * (perhaps unzipObject.allText) 
				 * 
				 * name these local variables allText and allImagePaths and the below code should already work
				...
				*/
				...
				//b.putStringArrayList("text", allText);
				//b.putStringArrayList("image paths", allImagePaths);
				i.putExtra("bundle", b);
				startActivity(i);
			}
		});
